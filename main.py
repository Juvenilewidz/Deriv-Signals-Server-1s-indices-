...
def detect_signal(candles, tf, shorthand):
    ...
    if DEBUG:
        ...
        print(f"  MA1 (SMMA HLC3-9): {current_ma1:.5f if current_ma1 else 'None'}")
        print(f"  MA2 (SMMA Close-19): {current_ma2:.5f if current_ma2 else 'None'}")
        print(f"  MA3 (SMA MA2-25): {current_ma3:.5f if current_ma3 else 'None'}")
