...
Core DSR Strategy (Version 1 Logic):
...
# -------------------------
# WebSocket Data Fetching (Version 2 robust implementation)
# -------------------------
...
# -------------------------
# Core DSR Signal Detection (Version 1 Logic)
# -------------------------
def detect_signal(candles, tf, shorthand):
    """Complete DSR Strategy - Version 1 rules implemented exactly"""
    n = len(candles)
    if n < MIN_CANDLES:
        return None
...
def run_analysis():
    ...
    for shorthand, deriv_symbol in SYMBOL_MAP.items():
        try:
            tf = 300  # Using 5-minute timeframe
